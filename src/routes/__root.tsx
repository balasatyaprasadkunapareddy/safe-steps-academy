...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SafeSteps — Traffic Safety Learning for Students" },
      {
        name: "description",
        content:
          "SafeSteps teaches school students road safety through lessons, Indian traffic signs, quizzes, badges and awareness surveys.",
      },
